...
- **Integration gaps**: Utility functions (validators, helpers) that exist but are not invoked by calling code (unused imports, dead code paths)
- **Example**: A function accepts an array but never checks if it's empty or contains valid elements
- **Example**: A validation or helper function exists but is never called by the code that should use it
...
Create the `context/bugs/XXX/research/` directory if it doesn't exist:

```bash
mkdir -p context/bugs/XXX/research/
```
...
2. **Identify potential CODE-LOGIC issues** via static analysis:
   ...
   - **Integration gaps**: Utility/helper functions that exist but are not called by the code that should use them (unused imports, missing wiring between layers)
...
Create `context/bugs/XXX/research/codebase-research.md` with the following structure:
...
Open `context/bugs/XXX/research/codebase-research.md` and review all issues.
...
Create `context/bugs/XXX/research/verified-research.md` with the exact structure below:
...
- **Source Code**: `src/`
- **Test Files**: `__tests__/`, `tests/`
- **Bug Researcher Output**: `context/bugs/XXX/research/codebase-research.md`
```
...
Open `context/bugs/XXX/research/verified-research.md` and extract:
...
- **Verified Research**: `context/bugs/XXX/research/verified-research.md`
- **Bug Context**: `context/bugs/XXX/bug-context.md`
- **Source Code**: `src/`
...
### If `context/bugs/XXX/research/` directory doesn't exist

- Create it: `mkdir -p context/bugs/XXX/research/`
...
✅ `context/bugs/XXX/research/codebase-research.md` exists with all identified issues  
✅ `context/bugs/XXX/research/verified-research.md` exists with all required sections  
...
- **Output files**:
  - `context/bugs/XXX/research/codebase-research.md` — Initial bug research findings
  - `context/bugs/XXX/research/verified-research.md` — Verified issues with severity assessment
